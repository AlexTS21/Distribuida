...
public class ClockSyncServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.printf("Servidor RMI de Sincronización de Reloj iniciado en puerto %d.%n", RMI_PORT);
            
            System.out.println("Servidor inicializado y listo para la sincronización de clientes.");
