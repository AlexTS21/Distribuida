...
public class clientevista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Calculadora Cliente-RPC");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         try {
            ...
            Integer resultado = (Integer) client.execute("MiServidorRPC_Suma.sumar", params);
           ...
           /* jTextArea1.append("Error: Servidor desconectado\n");
            habilitarOperaciones(false);*/
           
            jTextArea1.append("Intentando reconectar con el servido\n");
    ...
    try {
            ...
            Object[] params = new Object[]{"Cliente conectado"};
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
         try {
            ...
            Object[] params = new Object[]{num1, num2};
            Integer resultado = (Integer) client.execute("MiServidorRPC_Resta.resta", params);
          ...
          /*  jTextArea1.append("Error: Servidor desconectado\n");
            habilitarOperaciones(false);*/
             ...
             jTextArea1.append("Intentando reconectar con el servidor...\n");
            intentarReconexionAutomatica();
            jLabel7.setText("Desconectado");
            jLabel7.setForeground(java.awt.Color.RED);
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
            ...
            Object[] params = new Object[]{num1, num2};
            Integer resultado = (Integer) client.execute("MiServidorRPC_Multiplicacion.multiplicacion", params);
            
            jTextArea1.append("️ Multiplicación: " + num1 + " * " + num2 + " = " + resultado + "\n");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
     try {
            ...
            if (num2 == 0) {
                jTextArea1.append("Error: No se puede dividir por cero\n");
                return;
            }
            
            Object[] params = new Object[]{num1, num2};
            Integer resultado = (Integer) client.execute("MiServidorRPC_Divicion.divicion", params);
